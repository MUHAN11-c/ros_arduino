...
class Arduino:
    ...
    def connect(self):
        try:
            print("Connecting to Arduino on port" + str(self.port) + "...")
            ...
            print("Connected at" + str(self.baudrate))
    ...
    def send(self, cmd):
        ...
        '''
        self.port.write((str(cmd) + '\r').encode('utf-8'))
        ...
        try:
            ...
            while attempts < ntries and (value == '' or value == 'Invalid Command' or value == None):
                try:
                    ...
                    print("Exception executing command: " + str(cmd))
                attempts += 1
        except:
            self.mutex.release()
            print("Exception executing command: " + str(cmd))
    ...
    def execute_ack(self, cmd):
        ...
        try:
            ...
            self.mutex.release()
            print("execute_ack exception when executing" + str(cmd))
            print(str(sys.exc_info()))
            return 0
    ...
    def update_pid(self, Kp, Kd, Ki, Ko):
        ...
        cmd = str('u ' + str(Kp) + ':' + str(Kd) + ':' + str(Ki) + ':' + str(Ko))
...
if __name__ == "__main__":
    ...
    print("Reading on analog port 0" + str(myArduino.analog_read(0)))
    print("Reading on digital port 0" + str(myArduino.digital_read(0)))
